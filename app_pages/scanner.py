...
def show():
    st.title("Scanner (STRAT-only) — Step 3")
    st.caption("Adds Sector Rotation + Rotation IN/OUT + Sector Drilldown. Still STRAT-only.")
    ...
    # =========================
    # QUICK MARKET READ + ROTATION IN/OUT (NEW)
    # =========================
